            ...
            attr: [
              {
                name: "class",
                value:
                  "bg-slate-900 border border-white/10 rounded-xl p-6 md:p-8 space-y-5"
              }
            ],
            children: [
              {
                ...
                children: [
                  {
                    node: {
                      type: "text",
                      value:
                        "Understanding Stocks: The Building Blocks of Wealth"
                    }
                  }
                ]
              },
                    ...
                    children: [
                      {
                        node: {
                          type: "text",
                          value:
                            "Common Stocks – Most widely held, granting voting rights and capital appreciation"
                        }
                      }
                    ]
                  },
                    ...
                    children: [
                      {
                        node: {
                          type: "text",
                          value:
                            "Preferred Stocks – Offer fixed dividends and higher claim in case of liquidation"
                        }
                      }
                    ]
                  },
                    ...
                    children: [
                      {
                        node: {
                          type: "text",
                          value:
                            "Growth Stocks – Focus on high potential future earnings, often reinvesting profits"
                        }
                      }
                    ]
                  },
                    ...
                    children: [
                      {
                        node: {
                          type: "text",
                          value:
                            "Dividend Stocks – Provide regular income through company profit distributions"
                        }
                      }
                    ]
                  }
                ...
                children: [
                  {
                    node: {
                      type: "text",
                      value: `While stocks offer significant upside, they also carry risk due to market volatility, economic shifts, and company-specific performance. ${app.name} mitigates these risks through diversification, algorithmic checks, and constant rebalancing of your stock portfolio.`
                    }
                  }
                ]
              },
            ...
            children: [
              {
                node: {
                  type: "text",
                  value: `${app.name} believes stock investing should be both data-driven and human-curated. Our investment team combines quantitative models with market experience to identify undervalued equities and sectors poised for growth. Each portfolio is constructed for resilience, growth, and clarity.`
                }
              }
            ]
          }
        ...
        attr: [
          {
            name: "class",
            value:
              "bg-slate-900 border border-white/10 rounded-xl p-8 space-y-6"
          }
        ],
        children: [
          {
                ...
                children: [
                  {
                    node: {
                      type: "text",
                      value:
                        "Fundamental analysis of revenue growth, earnings stability, and financial health"
                    }
                  }
                ]
              },
                ...
                children: [
                  {
                    node: {
                      type: "text",
                      value:
                        "Technical analysis using trend indicators and volume signals"
                    }
                  }
                ]
              },
                ...
                children: [
                  {
                    node: {
                      type: "text",
                      value:
                        "Sector rotation strategies to capture macroeconomic cycles"
                    }
                  }
                ]
              },
                ...
                children: [
                  {
                    node: {
                      type: "text",
                      value:
                        "AI forecasting for pattern recognition and risk assessment"
                    }
                  }
                ]
              }
                ...
                children: [
                  {
                    node: {
                      type: "text",
                      value:
                        "Know exactly where your money is allocated, track every equity, and see detailed reports on performance and fees — updated in real time."
                    }
                  }
                ]
              }
                ...
                children: [
                  {
                    node: {
                      type: "text",
                      value:
                        "Our intelligent harvesting tools help minimize your tax burden, by offsetting gains with strategic losses and optimizing holding periods."
                    }
                  }
                ]
              }
