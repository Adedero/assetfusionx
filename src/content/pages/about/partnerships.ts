            ...
            attr: [
              {
                name: "class",
                value:
                  "max-w-[28rem] bg-slate-800 rounded-lg p-6 border border-white/10 text-slate-200 italic text-center"
              }
            ],
            children: [
              {
                node: {
                  type: "text",
                  value:
                    "“The strength of our platform is a reflection of the extraordinary partners who help us imagine what's possible and bring it to life.”"
                }
              }
            ]
          }
