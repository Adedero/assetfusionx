        ...
        children: [
                ...
                children: [
                    {
                        node: {
                            type: "text",
                            value: `${app_1.default.name} was born out of a vision to simplify the world of investing and make smart asset management accessible to everyone, regardless of financial background or expertise.`
                        }
                    }
                ]
            },
                        ...
                        children: [
                            {
                                node: {
                                    type: "text",
                                    value: `At our core, we believe that great investment opportunities shouldn't be locked behind complex jargon or exclusive financial clubs. That's why ${app_1.default.name} does the hard work for you — analyzing trends, selecting promising assets, and delivering returns without the stress of self-managed portfolios.`
                                }
                            }
                        ]
                    }
            ...
            // Mission & Values
            {
                ...
                attr: [
                    {
                        name: "class",
                        value: "bg-gradient-to-b from-primary-500/10 border border-white/10 rounded-lg p-8"
                    }
                ],
                children: [
                    {
                                        ...
                                        children: [
                                            {
                                                node: {
                                                    type: "text",
                                                    value: "Every decision, every trade, every fee is clearly communicated. No hidden costs, no surprise charges, no unclear performance metrics."
                                                }
                                            }
                                        ]
                                    }
                                        ...
                                        children: [
                                            {
                                                node: {
                                                    type: "text",
                                                    value: "Leveraging cutting-edge AI and machine learning to identify opportunities that traditional analysis might miss."
                                                }
                                            }
                                        ]
                                    }
                        ...
                        children: [
                            {
                                node: {
                                    type: "text",
                                    value: `From onboarding to payout, everything is streamlined. You choose your focus — we handle everything else. That's the ${app_1.default.name} promise.`
                                }
                            }
                        ]
                    }
                        ...
                        children: [
                            {
                                node: {
                                    type: "text",
                                    value: `${app_1.default.name} employs sophisticated algorithms and real-time market analysis to make investment decisions. Our proprietary risk assessment models continuously monitor market conditions, automatically adjusting portfolios to protect your investments while maximizing growth opportunities.`
                                }
                            }
                        ]
                    },
                                        ...
                                        children: [
                                            {
                                                node: {
                                                    type: "text",
                                                    value: "Machine learning models process thousands of data points to identify emerging market trends and investment opportunities."
                                                }
                                            }
                                        ]
                                    }
                                        ...
                                        children: [
                                            {
                                                node: {
                                                    type: "text",
                                                    value: "Dynamic portfolio rebalancing and stop-loss mechanisms protect your capital during market volatility."
                                                }
                                            }
                                        ]
                                    }
                                        ...
                                        children: [
                                            {
                                                node: {
                                                    type: "text",
                                                    value: "Lightning-fast trade execution ensures you never miss market opportunities or face unnecessary delays."
                                                }
                                            }
                                        ]
                                    }
                ...
                children: [
                    {
                        ...
                        attr: [
                            {
                                name: "class",
                                value: "flex items-center gap-1 text-xl font-semibold text-white"
                            }
                        ],
                        children: [
                            {
                                ...
                                children: [
                                    {
                                        node: {
                                            type: "text",
                                            value: "Fully managed investments tailored to your risk tolerance and goals"
                                        }
                                    }
                                ]
                            },
                                ...
                                children: [
                                    {
                                        node: {
                                            type: "text",
                                            value: "Transparent performance tracking and regular profit payouts"
                                        }
                                    }
                                ]
                            },
                                ...
                                children: [
                                    {
                                        node: {
                                            type: "text",
                                            value: "Global asset diversification without the complexity"
                                        }
                                    }
                                ]
                            },
                                ...
                                children: [
                                    {
                                        node: {
                                            type: "text",
                                            value: "Built-in risk protection and smart capital deployment"
                                        }
                                    }
                                ]
                            },
                                ...
                                children: [
                                    {
                                        node: {
                                            type: "text",
                                            value: "SEC-compliant operations with full regulatory oversight"
                                        }
                                    }
                                ]
                            },
                                ...
                                children: [
                                    {
                                        node: {
                                            type: "text",
                                            value: "24/7 customer support and dedicated account management"
                                        }
                                    }
                                ]
                            }
            ...
            // Team Image
            {
                ...
                attr: [
                    ...
                    { name: "alt", value: `${app_1.default.name} team at work` },
                        ...
                        children: [
                            {
                                node: {
                                    type: "text",
                                    value: `${app_1.default.name} maintains the highest standards of security and regulatory compliance. Your funds are protected by industry-leading encryption, segregated accounts, and comprehensive insurance coverage.`
                                }
                            }
                        ]
                    },
